...
String user_oid = request.getParameter("oid");
int oid=Integer.parseInt(user_oid);

ResultSet rel = stmt.executeQuery("delete from reservation_make where oid="+oid);
ResultSet res = stmt.executeQuery("delete from is_at where oid="+oid);

response.setContentType("text/html");
pw.println("<html>");
pw.println("<H4>"+"Delete order sucessufully!"+"</H4>");
